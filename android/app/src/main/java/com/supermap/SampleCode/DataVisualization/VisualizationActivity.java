 ...
 * 2、示例数据：
 * 		目录../SuperMap/Demos/DataVisualizationDemo/hotMap.smwu;
 * 3、关键类型/成员:
...
public class VisualizationActivity extends Activity{
    ...
    FrameLayout frameLayoutLayout = null;
    Double v ;
    int z;
    ...
    private Handler mHandle = new Handler()
    {
        public void handleMessage(android.os.Message msg) {
            if(msg.what == 1000001) {
                LinearLayout layout = (LinearLayout) findViewById(R.id.layout_left);//R.id.layout_left
                layout.setVisibility(View.VISIBLE);
                layout2 = (LinearLayout) findViewById(R.id.charts_right);
                layout3 = (LinearLayout) findViewById(R.id.charts_right1);
                btn1 = (Button) findViewById(R.id.btn_hot);
                btn1.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        mTimeData.setEnabled(true);
                    }
                });

                btn2 = (Button) findViewById(R.id.btn_polymer);
                ...
                btn3 = (Button) findViewById(R.id.btn_density);
                ...
                btn4 = (Button) findViewById(R.id.btn_relative);
                ...
                mTimeData.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        timeData();
                        mTimeData.setEnabled(false);
                    }
                });

                btn5 = (Button) findViewById(R.id.btn_grid);
                ...
                btn6 = (Button) findViewById(R.id.btnBarChart);
    ...
    public void CreatePieChart(){
        ...
        legendView.setColumnWidth(legendView.getColumnWidth() + 60);	//设置图例子项宽度
    ...
    private void openMap(){
        ...
        frameLayoutLayout = (FrameLayout) findViewById(R.id.layout_timeline);
...
//        checkPermission();
    ...
    private void realTimeData(boolean bSelected){
        frameLayoutLayout.setVisibility(View.INVISIBLE);
        if(timeLine != null){
            timeLine.dispose();
            timeLine = null;
    ...
    private void initRelationMap()
    {
        ...
        for(int i = 0;i<mRelativeDatas.size();i++)
        {
            ...
            if(
                    name.equalsIgnoreCase("成都市") ||
                            ...
                            name.equalsIgnoreCase("长沙市") ||
                            name.equalsIgnoreCase("呼和浩特市") ||
                            name.equalsIgnoreCase("大理市")
        ...
        for(int j=0;j<targetArr.size();j++){
            ...
            {
                RelationalChartPoint relPoint1 = targetArr.get(k);
                if(relPoint1.getRelationName().equalsIgnoreCase("北京市")){
                    relPoint1.setWeighted(50);
                }else if(relPoint1.getRelationName().equalsIgnoreCase("上海市")){
                    relPoint1.setWeighted(45);
                }else if(relPoint1.getRelationName().equalsIgnoreCase("广州市")){
                    relPoint1.setWeighted(36);
                }else if(relPoint1.getRelationName().equalsIgnoreCase("成都市")){
                    relPoint1.setWeighted(40);
                }else if(relPoint1.getRelationName().equalsIgnoreCase("长春市")){
                    relPoint1.setWeighted(25);
                }else if(relPoint1.getRelationName().equalsIgnoreCase("长沙市")){
                    relPoint1.setWeighted(50);
                }

                if(relPoint1.getRelationName().equals(relPoint.getRelationName())==false){
                    relPoint.getRelationalPoints().add(relPoint1);
                }
            }
        }

        Resources res = VisualizationActivity.this.getResources();
