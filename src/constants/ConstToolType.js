...
export default {
  ...
  MAP_THEME_PARAM_RANGE_EXPRESSION: 'MAP_THEME_PARAM_UNIQUE_EXPRESSION',
  MAP_THEME_PARAM_RANGE_MODE: 'MAP_THEME_PARAM_UNIQUE_COLOR',
  ...
  // 工具视图高度级别
  HEIGHT: [scaleSize(100), scaleSize(150), scaleSize(250), scaleSize(720),scaleSize(0)],
