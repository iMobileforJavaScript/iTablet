...
const testData_android = {
  data: [
    { key: '数据可视化', path: ConstPath.SampleDataPath + 'hotMap/hotMap.smwu', outPath: ConstPath.SampleDataPath, fileName: "hotMap", filePath: ConstPath.SampleDataPath + 'hotMap.zip' },
    ...
    { key: '三维场景', path: ConstPath.SampleDataPath + 'CBD_android/CBD_android.sxwu', outPath: ConstPath.SampleDataPath, fileName: "CBD_android", filePath: ConstPath.SampleDataPath + 'CBD_android.zip', openPath: ConstPath.SampleDataPath + 'CBD_android/CBD_android.sxwu' },
    { key: '倾斜摄影', path: ConstPath.SampleDataPath + 'MaSai/MaSai.sxwu', outPath: ConstPath.SampleDataPath, fileName: "MaSai", filePath: ConstPath.SampleDataPath + 'MaSai.zip', openPath: ConstPath.SampleDataPath + 'MaSai/MaSai.sxwu' }
  ]
}
const testData_ios = {
  data: [
