  ...
  componentDidUpdate(prevProps) {
    if (
      ...
      this.setState({
        ...
        plusAble:
          this.props.maxValue === '' || this.props.value < this.props.maxValue,
        miusAble:
          this.props.minValue === '' || this.props.value > this.props.minValue,
      })
    }
  }
      ...
      <View style={styles.chooseNumberContainer}>
        ...
        >
          <Image
            ...
            source={require('../../assets/public/icon-minus.png')}
          />
        </TouchableOpacity>
        ...
        >
          <Image
            style={styles.imageBtn}
            source={require('../../assets/public/icon-plus.png')}
          />
        </TouchableOpacity>
      </View>
    )
