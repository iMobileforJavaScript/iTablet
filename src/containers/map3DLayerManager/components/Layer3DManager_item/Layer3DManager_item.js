...
export default class Layer3DManager_item extends React.Component {
  ...
  render() {
    ...
    const image3 = this.state.selectable
      ? require('../../../../assets/public/select.png')
      : require('../../../../assets/public/select-off.png')
    const image4 = this.state.rowShow
      ? require('../../../../assets/public/show.png')
      : require('../../../../assets/public/show-off.png')
    return (
        ...
        <View style={styles.rowOne}>
          <View style={styles.btn_container}>
            ...
            <TouchableOpacity
              style={styles.btn}
              underlayColor={Util.UNDERLAYCOLOR}
              onPress={this._setObjectsColor}
            >
              <Image style={styles.btn_image} source={image3} />
            </TouchableOpacity>
          </View>
          ...
          >
            <Image style={styles.btn_image} source={image4} />
          </TouchableOpacity>
        </View>
        {isShow && (
