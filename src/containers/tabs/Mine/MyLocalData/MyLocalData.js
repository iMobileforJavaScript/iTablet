    ...
    try {
      ...
      if (this.itemInfo !== undefined) {
        ...
        if (is3D === true) {
          ...
          if (result === true) {
            Toast.show( getLanguage(this.props.language).Prompt.IMPORTED_3D_SUCCESS)
          } else {
            Toast.show(getLanguage(this.props.language).Prompt.FAILED_TO_IMPORT_3D)
          }
        } else {
