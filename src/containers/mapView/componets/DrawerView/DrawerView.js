...
export default class DrawerView extends React.Component {
  ...
  constructor(props) {
    ...
    this._drawerHeight = props.thresholds.length > 0 ? props.thresholds[0] : drawerHeight
  ...
  render() {
    if (this.props.hiddenAble && !this.state.visible) {
      ...
      return (
        <TouchableOpacity
          ...
          style={this.props.showBtnStyle ? this.props.showBtnStyle : styles.showBtnStyle}
          onPress={this.showBtnAction}
        >
          <Image
            resizeMode={'contain'}
            style={styles.showBtnImage}
            source={this.props.showBtnImage || require('../../../../assets/map/icon-arrow-up.png')}
          />
        </TouchableOpacity>
      )
    }
    return (
      <Animated.View
        style={[styles.container, this.props.containerStyle, this.props.thresholds.length > 0 && {height: this.props.thresholds[0]}]}
      ...
      >
        ...
        >
          <Image style={styles.drawerBtnImage} source={require('../../../../assets/map/icon-drawer.png')} />
        </View>
        {this.props.children}
      </Animated.View>
    )
