    ...
    let data = [
      {
        ...
        action: async cbData => await this.changeTap(cbData, Const.NETWORK_ROUTE),
        operations: [
          { key: '设置', action: () => this._setting(Const.NETWORK_ROUTE), size: 'large',image: require('../../../../assets/mapTools/icon_setting.png'), selectedImage: require('../../../../assets/mapTools/icon_setting_selected.png'), selectMode: 'flash' },
        ...
        ]},
      {
        ...
        action: async cbData => await this.changeTap(cbData, Const.NETWORK_FACILITY),
        operations: [
          { key: '设置',  action: () => this._setting(Const.NETWORK_FACILITY), size: 'large',image: require('../../../../assets/mapTools/icon_setting.png'), selectedImage: require('../../../../assets/mapTools/icon_setting_selected.png'), selectMode: 'flash' },
      ...
      },
      {
        ...
        action: async cbData => await this.changeTap(cbData, Const.NETWORK_TSP),
        operations: [
          { key: '设置',  action: () => this._setting(Const.NETWORK_TSP), size: 'large',image: require('../../../../assets/mapTools/icon_setting.png'), selectedImage: require('../../../../assets/mapTools/icon_setting_selected.png'), selectMode: 'flash' },
          { key: '添加配送中心', action: () => this._setCenter(Const.NETWORK_TSP), size: 'large', image: require('../../../../assets/mapTools/icon_add_center.png'), selectedImage: require('../../../../assets/mapTools/icon_add_center_selected.png') },
          { key: '添加目的地', action: () => this._setDist(Const.NETWORK_TSP), size: 'large', image: require('../../../../assets/mapTools/icon_add_destination.png'), selectedImage: require('../../../../assets/mapTools/icon_add_destination_selected.png') },
      ...
      },
      {
        ...
        action: async cbData => this.changeTap(cbData, Const.NETWORK_TRACKING),
        operations: [
          { key: '设置',  action: () => this._setting(Const.NETWORK_TRACKING), size: 'large',image: require('../../../../assets/mapTools/icon_setting.png'), selectedImage: require('../../../../assets/mapTools/icon_setting_selected.png'), selectMode: 'flash' },
